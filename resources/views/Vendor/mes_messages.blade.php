        ...
        <div class="row">
            ...
            <div class="col-md-8 mx-auto">
                <div class="row justify-content-between">
                    ...
                    <a href="{{ $users->previousPageUrl() }}"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>
                    </a>
                    @endif

                    @if($users->hasMorePages())
                    <a href="{{ $users->nextPageUrl() }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                    </a>
                    @endif
                    @endif
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a href="{{ route('Vendor.messages_by_id',$chat->id) }}">
